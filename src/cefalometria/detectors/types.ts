...
export const MODELS: Record<ModelKey, ModelInfo> = {
  mediapipe: {
    ...
    description: '478 landmarks. Excellent frontal, limited on pure profile. Lightweight (~3.7 MB).',
    points: 478,
  },
  faceapi: {
    key: 'faceapi',
    ...
    shortLabel: 'face-api',
    description: '68 landmarks (iBUG 300-W). Pose-robust SSD MobileNet detector, includes some profile. ~5.5 MB.',
    points: 68,
  },
  custom: {
    key: 'custom',
    ...
    shortLabel: 'Custom',
    description: '21 profilometric landmarks trained on your dataset (YOLOv8-pose). Profile only, 100% local.',
    points: 21,
  },
};
